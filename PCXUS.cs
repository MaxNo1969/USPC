...
namespace USPC
{
    ...
    public class PCXUS
    {
        ...
        [DllImport("DLL_PCXUS.dll")]
        public static extern Int32 PCXUS_ACQ_ASCAN(Int32 Board, Int32 Test, [In,Out] ref Ascan ascan, Int32 Timeout);
        [DllImport("DLL_PCXUS.dll")]
        ...
        {
            int serialNumber;
            PCXUS_Get_Serial_Number(_board, out serialNumber);
            return serialNumber;
        }
        ...
        {
            Int32 err = PCXUS_Open(out hPCXUS, _mode);
            if (err != 0)
            {
                log.add(LogRecord.LogReason.error, "{0}: {1}: Error: 0x{2:08X}", GetType().Name, System.Reflection.MethodBase.GetCurrentMethod().Name, err);
                return false;
            }
            else
            {
        ...
        public bool config(Int32 _board, Int32 _bufferSize)
        {
            ...
            Int32 Param = 0;
            // Setup acquisition
            Int32 err = PCXUS.PCXUS_ACQ_CONFIG(
                hPCXUS,
                _board,
                AcqMode,
                StartMode,
        ...
        public Int32 read(Int32 _board, byte[] _data)
        {
        ...
        public Int32 read(Int32 _board, AcqAscan[] _data)
        {
            if (!checkHandle()) return 0;
            Int32 TimeOut = 1000;
            Int32 NumberOfRead = 0;
